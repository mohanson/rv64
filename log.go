...
func DebuglnRType(i string, rd uint64, rs1 uint64, rs2 uint64) {
	Debugln(fmt.Sprintf("Instr: % 10s | rd: %#02x rs1: %#02x rs2: %#02x", i, rd, rs1, rs2))
}

func DebuglnR4Type(i string, rd uint64, rs1 uint64, rs2 uint64, rs3 uint64) {
	Debugln(fmt.Sprintf("Instr: % 10s | rd: %#02x rs1: %#02x rs2: %#02x rs3: %#02x", i, rd, rs1, rs2, rs3))
}

func DebuglnIType(i string, rd uint64, rs1 uint64, imm uint64) {
	Debugln(fmt.Sprintf("Instr: % 10s | rd: %#02x rs1: %#02x imm: %#04x", i, rd, rs1, imm))
}

func DebuglnSType(i string, rs1 uint64, rs2 uint64, imm uint64) {
	Debugln(fmt.Sprintf("Instr: % 10s | rs1: %#02x rs2: %#02x imm: %#04x", i, rs1, rs2, imm))
}
...
func DebuglnUType(i string, rd uint64, imm uint64) {
	Debugln(fmt.Sprintf("Instr: % 10s | rd: %#02x imm: %#04x", i, rd, imm))
}
